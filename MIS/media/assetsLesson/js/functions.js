...
var e = {
    ...
    darkMode: function () {
        ...
        var changeThemeToDark = () => {
          ...
          if(dir == 'rtl') {
              style.setAttribute('href', '/media/assetsLesson/css/style-dark-rtl.css');
          } else {
              style.setAttribute('href', '/media/assetsLesson/css/style-dark.css');
          }
        ...
        var changeThemeToLight = () => {
          ...
          if(dir == 'rtl') {
              style.setAttribute('href', '/media/assetsLesson/css/style-rtl.css');
          } else {
              style.setAttribute('href', '/media/assetsLesson/css/style.css');
          }

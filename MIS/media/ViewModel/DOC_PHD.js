function viewModel() {
	...
	self.getDisable1 = function (sn, year) {
		if (sn == 1 && year > 20) return true;
		if (sn == 2 && year < 24) return true;
		if (sn >= 9 && sn <= 32 && year < 24) return true;
		if (sn >= 33 && sn <= 34) return true;
		if (sn >= 35 && sn <= 38 && year < 24) return true;
		if (sn == 47) return true;
		return false;
	};
	...
	self.getDisable2 = function (sn, year) {
		if (sn == 1 && year > 20) return true;
		if (sn == 2 && year < 24) return true;
		if (sn >= 5 && sn <= 6 && year < 24) return true;
		if (sn >= 9 && sn <= 38 && year < 24) return true;
		return false;
	};
}
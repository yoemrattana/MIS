function viewModel() {
    ...
    */
    function getData() {
        app.ajax('VMWFollowupData/getData', { province: self.pv(), year: self.year(), month: self.month() }).done(function (rs) {
            dataArr = rs
    ...
    self.loadFollowup = function (callback, page) {
        ...
        app.ajax('VMWFollowupData/getFollowup', { case_id: case_id, day: day }).done(function (rs) {
            if (rs.followup != null) {

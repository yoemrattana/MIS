...
class IPT extends REST_Controller
{
	...
	public function form_get()
	{
		...
		$sql = "select a.Rec_ID as HouseMemberID,b.Month, b.Year,a.Name, a.Age, a.Sex, IPTDate, DoNotUse,Reject, Date,
				a.HouseHoldID,NotEnterForest,RefuseReason,Absent,iif(a.IPT = 'Yes' ,1,0) as IsIPT from
				(
					select * from tblLastmileHouseMember where ForestEntry = 'Yes' and Sex = 'M' and Age between 15 and 49
				) as a
				left join
				(

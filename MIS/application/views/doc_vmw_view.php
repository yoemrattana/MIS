...
<div class="panel panel-default" data-bind="visible: true" style="display:none">
	<div class="panel-heading clearfix">
		<div class="pull-left" style="position:sticky; left:21px">
			<button class="btn btn-default menu">VMW Availability</button>
			<button class="btn btn-default menu">VMW Accessibility</button>
			<button class="btn btn-default menu">VMW Comp-Accuracy</button>
		</div>
	...
	<div class="panel-heading clearfix">
		<div class="pull-left form-inline" style="position:sticky; left:21px">
			...
			<div class="input-group">
				...
				<select class="form-control minwidth100" data-bind="value: vmw, options: vmwList(), optionsValue: 'code', optionsText: 'name', optionsCaption: ''"></select>
			</div>
...
<?=latestJs('/media/ViewModel/DOC_VMW.js')?>
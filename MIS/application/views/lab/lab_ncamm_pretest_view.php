		...
		<table class="table table-bordered widthauto">
			<thead class="bg-thead">
				<tr>
					...
					<th width="70">Smear 1</th>
					<th width="70">Smear 2</th>
				</tr>
			</thead>
			<tbody data-bind="foreach: listModel, fixedHeader: true">
				<tr>
					...
					<td align="center">
						<a data-bind="click: () => $root.showSmear($data, 1)">Detail</a>
					</td>
					<td align="center">
						<a data-bind="click: () => $root.showSmear($data, 2)">Detail</a>
					</td>
				</tr>
			</tbody>
		</table>

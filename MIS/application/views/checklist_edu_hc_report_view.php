	...
	<div id="receiptData">
		<div id="content">
			...
			<div class="content-body">
				...
				<h3>៤. គោលបំណង</h3>
				<ul>
					<li>ពិនិត្យការងារគ្រប់គ្រងការងារគ្រុនចាញ់</li>
					<li>ពិនិត្យការងារជាទម្លាប់របស់មណ្ឌលសុខភាព</li>
					<li>សាកសួរឆ្នាំនេះមណ្ឌលសុខភាពបានទទួលមុង/មុងអង្រឹងជ្រលក់ថ្នាំដែរឫទេ</li>
				...
				<ul>
					...
					<li>ពិនិត្យការប្រជុំអ្នកស្ម័គ្រចិត្តភូមិព្យាបាលជំងឺគ្រុនចាញ់</li>
					<li>ពិនិត្យសកម្មភាពអប់រំសុខភាពនៅថ្នាក់មណ្ឌលសុខភាព</li>
					<li>ពិនិត្យសកម្មភាពអប់រំសុខភាពនៅថ្នាក់សហគមន៍</li>
				</ul>
...
<?=latestJs('/media/ViewModel/Checklist_EduHcReport.js')?>
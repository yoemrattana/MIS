...
<div class="panel panel-default" data-bind="hidden: isListView" style="margin:-10px; display:none">
	<div class="panel-heading clearfix" data-bind="with: master">
		<div class="pull-left lh26" style="position:sticky; left:11px">
			<kh class="text-bold">ខេត្ត</kh>
			<kh data-bind="text: prov"></kh>

			<kh style="margin-left:20px" class="text-bold">កង</kh>
			<kh data-bind="text: kh"></kh>

			<kh style="margin-left:20px" class="text-bold">របាយការណ៍ខែ</kh>
			<span data-bind="text: month"></span>
		</div>
		<div class="pull-right" style="position:sticky; right:11px">
			<button class="btn btn-primary btn-sm width100" data-bind="click: $root.saveReport, visible: app.user.permiss['Police Data'].contain('Edit')">Save</button>
			<button class="btn btn-danger btn-sm width100" data-bind="click: $root.deleteReport, visible: has && app.user.permiss['Police Data'].contain('Delete')">Delete</button>
		...
		<table id="tblcase" class="table table-bordered table-hover">
			<thead>
				<tr>
					...
					<td width="150"><kh>កន្លែងព្យាបាល</kh><br />Treatment place</td>
				...
				<tr data-bind="click: app.selectTr">
					...
					<td>
						<select data-bind="value: Participant">
							...
							<option></option>
							<!-- /ko -->
							<option value="Police">នគរបាល Police</option>
					...
					<td>
						<input type="text" data-bind="value: TreatmentPlace" />
					</td>
					<td>
					...
					<td>
						<div class="btn-group" data-bind="visible: Rec_ID() == -1">
							<button class="btn btn-primary btn-xs" style="width:70px" data-bind="click: $root.addCase, visible: app.user.permiss['Police Data'].contain('Edit')">Add</button>
						...
						<button class="btn btn-danger btn-xs btn-block" data-bind="visible: Rec_ID() > -1 && app.user.permiss['Police Data'].contain('Delete'), click: $root.deleteCase">Delete</button>
					</td>
				</tr>
			</tbody>
		</table>
	...
	<div class="panel-footer text-center">
		<button class="btn btn-primary btn-sm width150" data-bind="click: saveReport, visible: app.user.permiss['Police Data'].contain('Edit')">Save</button>
	</div>
</div>
...
<?=latestJs('/media/ViewModel/PLCase.js')?>
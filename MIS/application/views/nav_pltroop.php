...
<div id="sysmenuboard" class="panel panel-default" style="display:none" data-bind="visible: true">
	<div class="panel-heading clearfix">
		...
		<div class="pull-right">
			<button class="btn btn-primary btn-sm minwidth100" data-bind="click: showCreate">Add Troop</button>
		...
		<table class="table table-bordered table-striped table-hover">
			...
			<tbody data-bind="foreach: listModel, fixedHeader: [0,2]">
				<tr>
					...
					<td data-bind="text: Code_Troop_T"></td>
					<td align="center">
	...
	<div class="modal-dialog">
		<div class="modal-content" role="document">
			...
			<div class="modal-body form-horizontal" data-bind="with: editModel">
				...
				<div class="form-group">
					<label class="control-label col-xs-3">Troop Name EN:</label>
					<div class="col-xs-9">
						<input type="text" class="form-control" data-bind="value: Name_Troop_E" />
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-xs-3">Troop Name KH:</label>
					<div class="col-xs-9">
						<div class="input-group">
							<input type="text" class="form-control" data-bind="value: Name_Troop_K" />
							<span class="input-group-addon">Unicode</span>
						</div>
					</div>
				</div>
				<div class="form-group no-margin-bottom">
					<label class="control-label col-xs-3">Troop Code:</label>
					<div class="col-xs-9">
						<p class="form-control-static" data-bind="text: Code_Troop_T" />
					</div>
				</div>
			</div>
...
<?=latestJs('/media/ViewModel/Nav_PLTroop.js')?>
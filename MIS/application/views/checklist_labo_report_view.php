	...
	<div id="receiptData">
		<div id="content">
			...
			<div class="content-body">
				...
				<h3>៤. គោលបំណង</h3>
				<ul>
					<li>ពិនិត្យមន្ទីរពិសោធន៍របស់មន្ទីរពេទ្យ</li>
				...
				<ul>
					<li>ពិនិត្យឯកសារមន្ទីរពិសោធន៍</li>
					<li>ពិនិត្យនិតិវិធី</li>
					<li>ពិនិត្យការវាយតម្លៃអំពីកម្រិតជំនាញ</li>
					<li>ពិនិត្យការត្រួតពិនិត្យនិងធានាគុណភាព</li>
				</ul>
...
<?=latestJs('/media/ViewModel/Checklist_LaboReport.js')?>
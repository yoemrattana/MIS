<style type="text/css" media="all">
    * {
    ...
    .text-header-moul {font-family: 'Khmer OS Muol'; text-align: center !important; padding-bottom: 10px}
    .text-header-moul p {font-size: 19px}
	...
	<div id="receiptData">
		<div id="content">
			...
			<div class="content-body">
				...
				<p>
					ចាប់ពីថ្ងៃទី <span data-bind="text: date"></span> នៅស្រុកប្រតិបត្តិ 
				...
				<ul>
					<li>សាកសួរស្រុកប្រតិបត្តិ មានផែនការសកម្មភាពសំរាប់កម្មវិធីគ្រុនចាញ់ដែរឬទេ</li>
					<li>សាកសួរស្រុកប្រតិបត្តិបានអនុវត្តតាមផែនការដែរឬទេ? ផ្ទៀងផ្ទាត់ជាមួយផែនការថវិកា​ទាំងអស់របស់ស្រុកប្រតិបត្តិ</li>
					<li>ពិនិត្យការចែកមុងជ្រលក់ថ្នាំ(LLIN/LLHIN ITN)ក្នុងតំបន់គ្របដណ្តប់ដោយស្រុកប្រតិបត្តិក្នុង៣ខែចុងក្រោយ</li>
					<li>សាកសួរស្រុកប្រតិបត្តិ ការចុះត្រួតពិនិត្យតាមដាននិងវាយតំលៃការងារគ្រុនចាញ់ក្នុង៣ខែចុងក្រោយនេះដែរឫទេ</li>
			...
			<div class="content-footer">
				...
				<div class="right">
					<p>ភ្នំពេញ, <?php echo date('d-m-Y')?></p>
...
<?=latestJs('/media/ViewModel/Checklist_MnEReport_OD.js')?>
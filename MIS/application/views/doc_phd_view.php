...
<div class="panel panel-default" data-bind="visible: true" style="display:none">
	<div class="panel-heading clearfix">
		<div class="pull-left" style="position:sticky; left:21px">
			<button class="btn btn-default menu">PHD Availability</button>
			<button class="btn btn-default menu">PHD Accessibility</button>
			<button class="btn btn-default menu">PHD Comp-Accuracy</button>
		</div>
...
<?=latestJs('/media/ViewModel/DOC_PHD.js')?>
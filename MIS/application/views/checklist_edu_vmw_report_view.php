	...
	<div id="receiptData">
		<div id="content">
			...
			<div class="content-body">
				...
				<p>
					ចាប់ពីថ្ងៃទី
					<span data-bind="text: date"></span> នៅភូមិ
				...
				<h3>៤. គោលបំណង</h3>
				<ul>
					<li>សារសួរVMWអំពីសកកម្មភាពគ្រុនចាញ់</li>
				</ul>

				<h3>៥. វិធីសាស្រ្ត / ដំណើរការសកម្មភាពការងារ</h3>
				<h3 style="margin-left:33px">៥.១ វិធីសាស្រ្ត៖ </h3>
				<ul>
					<li>ផ្ទៀងផ្ទាត់របាយការណ៍គ្រុនចាញ់ក្នុងរយៈពេល៣ខែមុន</li>
...
<?=latestJs('/media/ViewModel/Checklist_EduVMWReport.js')?>
	...
	<div class="panel-heading clearfix relative">
		<div class="pull-center form-inline">
			...
			<select data-bind="options: provList,
					...
					value: prov"
				class="form-control minwidth150 kh" style="padding:3px 12px"></select>

			<select data-bind="options: officeList,
					optionsValue: 'code',
					optionsText: 'name',
					optionsCaption: 'Select Office',
					value: office"
				class="form-control minwidth150 kh" style="padding:3px 12px"></select>

		</div>
		<div class="pull-left font16 lh28">
			<b>Environment Bednet Report</b>
		</div>
				...
				<tr data-bind="click: app.selectTr">
					...
					<th class="text-center text-middle no-padding font16">
						<a data-bind="text: has() ? 'X' : 'O',
						   ...
						   visible: $root.visibleReport($data)"
							style="padding-top:2px"></a>
					</th>
					<!-- /ko -->
				</tr>
			</tbody>
...
<div class="panel panel-default" data-bind="hidden: isListView" style="margin:-10px; display:none">
	<div class="panel-heading clearfix" data-bind="with: master">
		<div class="pull-left lh26">
			...
			<b style="margin-left:20px" class="kh">សហគមន៍</b>
		...
		<div class="pull-right">
			<button class="btn btn-primary btn-sm width100" data-bind="click: $root.saveReport, visible: app.user.permiss['Environment Bed Net'].contain('Edit')">Save</button>
			<button class="btn btn-danger btn-sm width100" data-bind="click: $root.deleteReport, visible: has && app.user.permiss['Environment Bed Net'].contain('Delete')">Delete</button>
...
<?=latestJs('/media/ViewModel/EnvBednet.js')?>
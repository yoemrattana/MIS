		...
		<table id="tblreport" class="table table-bordered table-striped table-hover">
			<thead>
				<tr>
					...
					<!-- /ko -->
					<th width="80" class="text-center">Has VMW</th>
				</tr>
			</thead>
...
<div class="panel panel-default" data-bind="hidden: isListView" style="margin:-10px -10px 0 -10px; display:none">
	<div class="panel-heading clearfix" data-bind="with: master">
		...
		<div class="pull-right">
			<button class="btn btn-primary btn-sm width100" data-bind="click: $root.saveReport, visible: app.user.permiss['VMW Data Accuracy'].contain('Edit')">Save</button>
            <button class="btn btn-danger btn-sm width100" data-bind="click: $root.deleteReport, visible: has && app.user.permiss['VMW Data Accuracy'].contain('Delete')">Delete</button>
	...
	<div class="panel-heading">
		<div class="form-inline relative" data-bind="with: master">
			<span><kh>ថ្ងៃចុះ</kh> (Mission Date)</span>
			<input type="text" class="form-control input-sm text-center" style="width:120px" data-bind="datePicker: DateAdded" />
            <span><kh>ពិនិត្យដោយ</kh></span> <span class="badge" data-bind="text: createdby"></span>
		</div>
	</div>
	<div class="panel-body no-padding">
		...
		<table id="tblcase" class="table table-bordered table-hover">
            <thead>
                <tr data-bind="click: app.selectTr">
                    <td>
                        <input type="number" disabled min="0" data-bind="value: getPVByVMW()" class="text-center" maxlength="2" />
                    </td>
                    <td>
                        <input type="number" disabled min="0" data-bind="value: getPFByVMW()" class="text-center" maxlength="3" />
                    </td>
                    <td>
                        <input type="number" disabled min="0" data-bind="value: getMixByVMW()" class="text-center" maxlength="4" />
                    </td>
                    <td>
                        <input type="number" disabled min="0" data-bind="value: getPositiveByVMW()" class="text-center" maxlength="4" />
                    </td>
                    <td>
                        <input type="number" disabled min="0" data-bind="value: getNegativeByVMW()" class="text-center" maxlength="4" />
                    </td>
                    <td>
                        <input type="number" disabled min="0" data-bind="value: getReferedByVMW()" class="text-center" maxlength="4" />
                    </td>
                </tr>
            </thead>
			<thead>
				<tr>
					<td><kh>ហ្វាល់ស៊ីប៉ារ៉ូម</kh><br />PF</td>
                    <td><kh>វីវ៉ាក់</kh><br />PV</td>
                    <td><kh>ចម្រុះ</kh><br />Mix</td>
                    <td><kh>វិជ្ជមាន</kh><br />Positive</td>
                    <td><kh>អវិជ្ជមាន</kh><br />Negative</td>
					<td><kh>បញ្ចូន</kh><br />Refered</td>
				</tr>
			</thead>
            <tbody data-bind="with: data, fixedHeader: true">
                <tr data-bind="click: app.selectTr">
                    <td>
                        <input type="number" min="0" data-bind="value: NumberPF" class="text-center" maxlength="2" />
                    </td>
                    <td>
                        <input type="number" min="0" data-bind="value: NumberPV" class="text-center" maxlength="3" />
                    </td>
                    <td>
                        <input type="number" min="0" data-bind="value: NumberMix" class="text-center" maxlength="4" />
                    </td>
                    <td>
                        <input type="number" min="0" data-bind="value: NumberPositive" class="text-center" maxlength="4" />
                    </td>
                    <td>
                        <input type="number" min="0" data-bind="value: NumberNegative" class="text-center" maxlength="4" />
                    </td>
                    <td>
                        <input type="number" min="0" data-bind="value: NumberRefered" class="text-center" maxlength="4" />
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="total" data-bind="with: data">
                    <div class="form-inline">
                        ...
                        <input type="number" min="0" class="form-control input-sm font14" data-bind="value: NumberTest" disabled/>
                    </div>
                    <div class="form-inline">
                        <p class="form-control-static">
                            <kh>វិជ្ជមាន</kh> (Positive Cases)
                        </p>
                        <input type="number" min="0" class="form-control input-sm font14" data-bind="value: NumberPositive, disable: IncludedSpecies" />
                        <label class="checkbox-inline checkbox-lg"><input type="checkbox" data-bind="checked: IncludedSpecies" /> Species</label>
                    </div>
                    ...
                    <div class="form-inline">
                        <p class="form-control-static">
                            <kh>អវិជ្ជមាន</kh> (Negative)
                        </p>
                        <input type="number" min="0" class="form-control input-sm font14" data-bind="value: NumberNegative" />
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6">
                <h4 class="text-center">
                    <k>ទិន្នន័យបញ្ចូលដោយ VMW</k> (Data By VMW)
                </h4>
                <div class="total">
                    <div class="form-inline">
                        <p class="form-control-static">
                        ...
                        <input type="text" class="form-control input-sm font14" data-bind="value: getTestByVMW()" disabled />
                    </div>
                    <div class="form-inline">
                        <p class="form-control-static">
                            <kh>វិជ្ជមាន</kh> (Positive Cases)
                        </p>
                        <input type="text" class="form-control input-sm font14" data-bind="value: getPositiveByVMW()" disabled />
                    </div>
                    ...
                    <div class="species">
                        <div class="form-inline">
                            ...
                            <input type="text" class="form-control input-sm font14" data-bind="value: getPFByVMW()" disabled />
                        </div>
                        <div class="form-inline">
                            <p class="form-control-static">
                                <kh>វីវ៉ាក់</kh> (PV)
                            </p>
                            <input type="text" class="form-control input-sm font14" data-bind="value: getPVByVMW()" disabled />
                        </div>
                        <div class="form-inline">
                            <p class="form-control-static">
                                <kh>ចម្រុះ</kh> (Mix)
                            </p>
                            <input type="text" class="form-control input-sm font14" data-bind="value: getMixByVMW()" disabled />
                        </div>
                    </div>
                    ...
                    <div class="form-inline">
                        ...
                        <input type="text" class="form-control input-sm font14" data-bind="value: getNegativeByVMW()" disabled />
                    </div>
                </div>
            </div>
        </div>
	...
	<div class="panel-footer text-center">
		<button class="btn btn-primary btn-sm width150" data-bind="click: saveReport, visible: app.user.permiss['VMW Data Accuracy'].contain('Edit')">Save</button>
	</div>
...
<?=latestJs('/media/ViewModel/VMWDataAccuracy.js')?>

...
<div class="panel panel-default" data-bind="visible: true" style="display:none">
	<div class="panel-heading clearfix">
		<div class="pull-left" style="position:sticky; left:21px">
			<button class="btn btn-default menu">PRH/RH Availability</button>
			<button class="btn btn-default menu">PRH/RH Accessibility</button>
			<button class="btn btn-default menu">PRH/RH Comp-Accuracy</button>
		</div>
	...
	<div class="panel-heading clearfix">
		<div class="pull-left form-inline" style="position:sticky; left:21px">
			...
			<div class="input-group">
				<span class="input-group-addon">PRH/RH</span>
...
<?=latestJs('/media/ViewModel/DOC_RH.js')?>
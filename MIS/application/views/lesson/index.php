			...
			<div class="col-12">
				<div class="row align-items-center">
					...
					<div class="col-6 col-md-3 text-center order-1">
						<img src="/media/assetsLesson/images/element/category-1.svg" alt="" />
					</div>
					...
					<div class="col-md-6 px-md-5 text-center position-relative order-md-2 mb-5 mb-md-0">
						...
						<p class="mb-3">Grow your skill with the most reliable online courses</p>
					...
					<div class="col-6 col-md-3 text-center order-3">
						<img src="/media/assetsLesson/images/element/category-2.svg" alt="" />
					</div>
		...
		<div class="row g-4">
			...
			<div class="col-sm-6 col-md-4 col-xl-3">
				<div class="card card-body bg-success bg-opacity-10 text-center position-relative btn-transition p-4">
					...
					<div class="icon-xl bg-body mx-auto rounded-circle mb-3">
						<img src="/media/assetsLesson/images/element/data-science.svg" alt="" />
					</div>
					<!-- Title -->
					<h5 class="mb-2">
						<a href="/Lesson/detail/MIS" class="stretched-link">MIS</a>
					</h5>
				</div>
			</div>
			...
			<div class="col-sm-6 col-md-4 col-xl-3">
				<div class="card card-body bg-orange bg-opacity-10 text-center position-relative btn-transition p-4">
					<!-- Image -->
					<div class="icon-xl bg-body mx-auto rounded-circle mb-3">
						<img src="/media/assetsLesson/images/element/online.svg" alt="" />
					</div>
					<!-- Title -->
					<h5 class="mb-2">
						<a href="/Lesson/detail/M&E" class="stretched-link">M&E</a>
					</h5>
				</div>
			</div>
			...
			<div class="col-sm-6 col-md-4 col-xl-3">
				<div class="card card-body bg-danger bg-opacity-10 text-center position-relative btn-transition p-4">
					<!-- Image -->
					<div class="icon-xl bg-body mx-auto rounded-circle mb-3">
						<img src="/media/assetsLesson/images/element/engineering.svg" alt="" />
					</div>
					<!-- Title -->
					<h5 class="mb-2">
						<a href="/Lesson/detail/EPI" class="stretched-link">Epi</a>
					</h5>
				</div>
			</div>
			...
			<div class="col-sm-6 col-md-4 col-xl-3">
				<div class="card card-body bg-purple bg-opacity-10 text-center position-relative btn-transition p-4">
					<!-- Image -->
					<div class="icon-xl bg-body mx-auto rounded-circle mb-3">
						<img src="/media/assetsLesson/images/element/coding.svg" alt="" />
					</div>
					<!-- Title -->
					<h5 class="mb-2">
						<a href="/Lesson/detail/VMW" class="stretched-link">VMW</a>
					</h5>
				</div>
			</div>
			...
			<div class="col-sm-6 col-md-4 col-xl-3">
				<div class="card card-body bg-info bg-opacity-10 text-center position-relative btn-transition p-4">
					<!-- Image -->
					<div class="icon-xl bg-body mx-auto rounded-circle mb-3">
						<img src="/media/assetsLesson/images/element/profit.svg" alt="" />
					</div>
					<!-- Title -->
					<h5 class="mb-2">
						<a href="/Lesson/detail/Education" class="stretched-link">Education</a>
					</h5>
				</div>
			</div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3">
                <div class="card card-body bg-info bg-opacity-10 text-center position-relative btn-transition p-4">
                    ...
                    <!-- Title -->
                    <h5 class="mb-2">
                        <a href="/Lesson/detail/Laboratory" class="stretched-link">Laboratory</a>
                    </h5>
                </div>
            </div>
		</div>
		...
		<div class="row g-4">
			...
			<div class="col-lg-6 position-relative overflow-hidden">
				<div class="bg-primary bg-opacity-10 rounded-3 p-5 h-100">
					...
					<div class="position-absolute bottom-0 end-0 me-3">
						<img src="/media/assetsLesson/images/element/08.svg" class="h-100px h-sm-200px" alt="" />
					</div>
					<!-- Content -->
					<div class="row">
						<div class="col-sm-8 position-relative">
							<h3 class="mb-1">Malaria Dashboard</h3>
							<p class="mb-3 h5 fw-light lead">Browse our malaria dashboard</p>
							<a href="Dashboard/V2" class="btn btn-primary mb-0">View Dashboard</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-6 position-relative overflow-hidden">
				<div class="bg-secondary rounded-3 bg-opacity-10 p-5 h-100">
					<!-- Image -->
					<div class="position-absolute bottom-0 end-0 me-3">
						<img src="/media/assetsLesson/images/element/15.svg" class="h-100px h-sm-200px" alt="" />
					</div>
					<!-- Content -->
					<div class="row">
						<div class="col-sm-8 position-relative">
							<h3 class="mb-1">Our Application</h3>
							<p class="mb-3 h5 fw-light lead">Browse our mobile application</p>
							<a href="/App/gallery" class="btn btn-warning mb-0">View App</a>
						</div>
					</div>
				</div>
			</div>
